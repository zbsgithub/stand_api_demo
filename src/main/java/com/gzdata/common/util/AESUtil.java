...
//    public static final String AES_TYPE = "AES/ECB/NoPadding";
    ...
    //私钥
    private static final String AES_KEY="family--portrait";   //AES固定格式为128/192/256 bits.即：16/24/32bytes。DES固定格式为128bits，即8bytes。
    ...
    public static String encrypt(String cleartext) {
        ...
        try {
        	...
        	logger.error("encrypt exist exception:",e);
            return "";
        }
    }
    ...
    public static String decrypt(String encrypted) {
        try {
        	...
        	logger.error("dencrypt exist exception:",e);
            return "";
        }
    }
